...
if( isset( $_POST['submit'] ) ) {
	...
	$data[ga-id] 		= filter_txt($_POST['ga-id']);
...
<table width="100%" border="0" cellpadding="4" cellspacing="2">
  ...
  <tr>
    ...
    <td align="left" valign="top"><textarea name="logo" style="width:80%;"><?php echo portal_theme_option('logo');?></textarea></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td align="left" valign="top"><strong>:</strong></td>
    <td align="left" valign="top"><input type="text" name="ga-id" value="<?php echo portal_theme_option('ga-id');?>" style="width:100px;" /></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td align="left" valign="top"><strong>:</strong></td>
    <td align="left" valign="top"><textarea name="ads468x60" style="width:80%;"><?php echo portal_theme_option('ads468x60');?></textarea></td>
  </tr>
  <tr>
    <td align="left" valign="top">Ads URL 160x600</td>
    <td align="left" valign="top"><strong>:</strong></td>
    <td align="left" valign="top"><textarea name="ads160x600" style="width:80%;"><?php echo portal_theme_option('ads160x600');?></textarea></td>
  </tr>
  <tr>
    <td align="left" valign="top">Ads URL 300x250</td>
    <td align="left" valign="top"><strong>:</strong></td>
    <td align="left" valign="top"><textarea name="ads300x250" style="width:80%;"><?php echo portal_theme_option('ads300x250');?></textarea></td>
  </tr>
  <tr>
